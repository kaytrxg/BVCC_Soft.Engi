...
import { AllDatasales } from '@/components/DataAnalyzer';
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <div>
                    ...
                    {numericMonthly.length === 0 ? (
                        <div className="p-4 border rounded bg-yellow-50 text-sm text-red-700">No numeric data available for "{selectedDatasetName}".</div>
                    ) : (
                    <ResponsiveContainer width="100%" height={300}>
                            {chartType === 'bar' ? (
